...
const openOrder = async (id) => {
  ...
  try {
    ...
    $("#dialog-content").innerHTML = `<div class="detail-grid"><div class="detail-item"><span>Customer</span><strong>${escapeHtml(order.customer.name)}</strong></div><div class="detail-item"><span>Phone</span><strong>${escapeHtml(order.customer.phone)}</strong></div><div class="detail-item"><span>VIN</span><strong>${escapeHtml(order.vehicle.vin)}</strong></div><div class="detail-item"><span>Transmission</span><strong>${escapeHtml(order.application)}</strong></div><div class="detail-item"><span>Package</span><strong>${escapeHtml(order.packageName)}</strong></div><div class="detail-item"><span>Collected</span><strong>${escapeHtml(formatMoney(order.collectedCents))}</strong></div></div>
